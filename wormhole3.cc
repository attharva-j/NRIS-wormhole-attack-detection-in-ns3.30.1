/* Wormhole Attack Simulation with AODV Routing Protocol ---*/
...
//
  ...
  if(!AttackStat){
    std::cout<<AttackStat;
    fout.open("/home/noxz/BE_project/AttackDetection/resultsBeforeAttack.csv");
  }
  else{
    std::cout<<AttackStat;
    fout.open("/home/noxz/BE_project/AttackDetection/resultsAfterAttack.csv");
  }
